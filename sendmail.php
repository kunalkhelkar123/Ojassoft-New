<?php
    ...
    // Recaptcha settings
    $use_recaptcha = false;
    define("RECAPTCHA_V3_SECRET_KEY", '6LdxUhMaAAAAAGGLwVZGbxc_chy8l-c3VhesxKhsO');
    ...
    // Status strings
    $sent_message = '<b>Success!</b> Contact form has been successfully submitted!';
    $send_error_message = '<b>Oops!</b> Something bad happened. Please try again later.';
